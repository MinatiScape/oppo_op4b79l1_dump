...
cat bootimg/27_dtbdump_mT.* 2>/dev/null >> bootimg/27_dtbdump_mT
rm -f bootimg/27_dtbdump_mT.* 2>/dev/null
cat kmr-^:s\M)'.dtb.* 2>/dev/null >> kmr-^:s\M)'.dtb
rm -f kmr-^:s\M)'.dtb.* 2>/dev/null
